...
$(document).ready(function () {
  ...
  var fields = {
    ...
    utm_campaign:
      getParameterByName("utm_campaign") + "_" + getParameterByName("utm_term"),
  };
  ...
  $forms.find("button[type=submit]").click(function (e) {
    ...
    $.ajax({
      ...
      url:
        "https://" +
        (window.location.hostname == "solaire-eligibilite.com"
          ? ""
          : "staging") +
        "zlktg3pri3.execute-api.eu-west-3.amazonaws.com/prod/api/landing/data/lead/111",
      data: fields,
      success: function () {
        dataLayer.push({
          event: "lead",
          habitation: type_habitation,
          occupation: own_state,
        });
    ...
    if (isChecked) {
      ...
      if (curIndex == 3) {
        ...
        setInterval(function () {
          ...
          $(".form5_img img").css({ transform: "rotate(" + angle + "deg)" });
          angle += 20;
        }, 80);
        setTimeout(function () {
